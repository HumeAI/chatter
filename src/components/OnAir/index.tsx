...
export const OnAir = () => {
  return (
    ...
    >
      <motion.div
        className={cn(
          'flex w-fit items-center justify-center rounded-xl border-4 p-1 px-3 [text-shadow:_0px_0px_4px_white,_3px_3px_10px_white,_0px_0px_15px_#f02eaa,_0px_0px_25px_#f02eaa,_0px_0px_35px_#f02eaa]',
